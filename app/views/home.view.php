				...
				<div class="row">
					...
					<div class="col-xl-3 col-xxl-7">
						<div class="card">
							...
							<div class="card-body">	
								<div class="user-bx">
									<img src="<?=ROOT?>/assets/Dashboard/images/ion/man (1).png" alt="">
									<div>
								...
								<ul class="user-list">
									<li><img src="<?=ROOT?>/assets/Dashboard/images/ion/bussiness-man.png" alt=""></li>
									<li><img src="<?=ROOT?>/assets/Dashboard/images/ion/hacker.png" alt=""></li>
									<li><img src="<?=ROOT?>/assets/Dashboard/images/ion/man (2).png" alt=""></li>
									<li><img src="<?=ROOT?>/assets/Dashboard/images/ion/woman.png" alt=""></li>
									<li><img src="<?=ROOT?>/assets/Dashboard/images/ion/man.png" alt=""></li>
									<li><img src="<?=ROOT?>/assets/Dashboard/images/ion/woman.png" alt=""></li>
